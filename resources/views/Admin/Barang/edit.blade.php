            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            <label for="stokU" class="form-label">Stok Awal <span
                                    class="text-danger">*</span></label>
                            <input type="text"
                        ...
                        <div class="form-group">
                            ...
                            <center>
                                <img src="{{ url('/assets/default/barang/image.png') }}" width="80%"
                                    alt="profile-user" id="outputImgU" class="">
                            </center>
...
@section('formEditJS')
    <script>
        $(document).ready(function() {
            // 1. AUTO FOCUS SAAT MODAL DIBUKA
            $('#modaldemo8').on('shown.bs.modal', function() {
                $("input[name='nama']").focus();
            });

            // 2. ENTER UNTUK PINDAH KOLOM (TAB)
            $('#modaldemo8').on('keydown', 'input, select', function(e) {
                if (e.key === "Enter") {
                    e.preventDefault();
                    var focusable = $('#modaldemo8').find('input, select').filter(
                    ...
                    if (index < focusable.length - 1) {
                        ...
                        // Jika di kolom terakhir, tekan enter akan trigger simpan
                        checkForm();
                    }
                }
            });
            ...
            $(document).keydown(function(e) {
                if ((e.ctrlKey || e.metaKey) && (e.key === 's' || e.key === 'S')) {
                    ...
                    // Cek apakah Modal EDIT (#Umodaldemo8) sedang terbuka
                    if ($('#Umodaldemo8').hasClass('show')) {
                        // console.log("Menyimpan data edit...");
                        checkFormU(); // Panggil validasi form EDIT (bukan checkForm biasa)
                    }
                }
            });
