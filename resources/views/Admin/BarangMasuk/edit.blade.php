            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="snU" class="form-label">Kode SN</label>
                            <input type="text" name="snU" class="form-control" placeholder="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
...
@section('formEditJS')
    <script>
        ...
        function resetValidU() {
            ...
            $("input[name='snU']").removeClass('is-invalid');
